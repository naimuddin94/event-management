const Banner = () => {
  return (
    <div className="bg-[url('https://i.ibb.co/n3bcKN3/web-summit-decoded-dublin-dublinglobe-com-1066x533.jpg')] h-screen bg-cover bg-center relative text-white flex items-center justify-center md:justify-start bg-black/30 bg-blend-overlay">
